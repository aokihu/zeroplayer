...
// GStreamer播放器结构体
typedef struct GstreamerPlayer
{
  gchar *uri;
  GstElement *pipeline;
} ZGstreamerPlayer;
 ...
 */
gboolean gstreamer_player_pause(struct GstreamerPlayer *player);
 ...
 */
gboolean gstreamer_player_stop(struct GstreamerPlayer *player);
 ...
 * @return gboolean 设置是否成功
 */
gboolean gstreamer_player_seek(struct GstreamerPlayer *player, gint64 position);
 ...
 */
gint64 gstreamer_player_get_position(struct GstreamerPlayer *player);
 ...
 */
gint64 gstreamer_player_get_duration(struct GstreamerPlayer *player);
 ...
 * @return gboolean 设置是否成功
 */
gboolean gstreamer_player_set_volume(struct GstreamerPlayer *player, gdouble volume);
 ...
 */
gdouble gstreamer_player_get_volume(struct GstreamerPlayer *player);
